...
- **PubMed-GraphRAG** (Master's Thesis) - Hybrid FAISS + Neo4j retrieval over 12.5M PubMed papers (20M nodes, 266M relationships) | [Dataset](https://huggingface.co/datasets/danielquillanroxas/pubmed-graphrag-data) | [Site]:(https://thesis-lime-delta.vercel.app)
